...
const MenuAdmin = () => {
  return (
    <div
      ...
      className="hs-overlay overflow-y-hidden fixed inset-y-0 start-0 z-[60] hidden w-64 -translate-x-full transform  border-e border-default-200 bg-white transition-all duration-300 hs-overlay-open:translate-x-0 dark:bg-default-50 lg:bottom-0 lg:right-auto lg:block lg:translate-x-0 hide-in-print"
    >
      ...
      <SimplebarReactClient className="h-1/2 overflow-y-auto ">
